...
export type ReminderIcon = 'droplet' | 'leaf' | 'arrows-repeat' | 'scissors' | 'sun' | 'thermometer-half';
export type ReminderKind = 'watering' | 'fertilizing' | 'repotting' | 'pruning' | 'light' | 'temperature';
